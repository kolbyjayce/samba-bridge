...
export class SMBClient {
    ...
    constructor(private options: SMBOptions) {
        ...
        this.packetConcurrency = options.packetConcurrency ? options.packetConcurrency : 20;
        this.autoCloseTimeout = options.autoCloseTimeout ? options.autoCloseTimeout : 10000; // default timeout to 10 seconds
